# -*- coding: utf-8 -*-
"""
Created on Sat Aug 11 17:05:28 2018
...
if __name__ == '__main__':
    ...
    estimator = ts_estimators.TimeSeriesRegressor(
      model=_LSTMModel(num_features=1, num_units=64),
      optimizer=tf.train.AdamOptimizer(0.001), model_dir="./model")
    ...
    observed_times = data1['times'].reshape(-1)
    observed = data1['values'].reshape(-1)
    ...
    plt.legend(handles=[observed_lines[0], evaluated_lines[0], predicted_lines[0]],
                 loc="upper left")
    plt.savefig('lstm_predict_result.jpg')
